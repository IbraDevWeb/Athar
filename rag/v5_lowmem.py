...
# search() resolves this helper through the v5_engine module globals, so patching
# it here preserves all V5 retrieval/ranking semantics while bounding RAM use.
