...
DEFAULT_OUTPUT = ROOT / "rag" / "data" / "athar_hosted.release"
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Cache l'asset du corpus RAG dans l'artefact de build Render.")
