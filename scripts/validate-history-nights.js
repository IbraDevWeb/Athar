...
["const APP_VERSION = 'athar-pro-v33'","writeEarlyScript('history_nights_data.js'",'css/history-nights.css?v=${APP_VERSION}'].forEach(t => need(config,t,'config.js'));
const worker = read('service-worker.js');
["const CACHE_VERSION = 'athar-pro-v33'",'./history_nights_data.js?v=athar-pro-v33','./css/history-nights-scroll.css?v=athar-pro-v33'].forEach(t => need(worker,t,'service worker'));
need(read('extensions_data.js'),'Récits historiques immersifs, sourcés','metadata');
console.log(`History Nights validated: ${data.stories.length} stories, ${chapters} chapters and cache v33.`);
